...
from app.create_channel.ui.dialog_user_name_for_channel_ui import DialogUserNameForChannelUi
...
class DialogUserNameForChannel(DialogUserNameForChannelUi):
    """
    ...
    def _info(self):
        ...
        '''Формирование user_name канала
Ограничения:
🔹 Основные правила:
1. Длина: от 5 до 32 символов (включительно).
...
- Слова в списках должны быть разделены переносом строки.
    ...
    def _save(self):
        ...
        if use_list_1 == False and use_list_2 == False and use_list_3 == False:
            info = DialogInfo('Внимание!', 'Ни один из списков не подходит, заполните их корректно!', 'notification.mp3')
            info.exec_()
            return
        ...
        cursor.execute(f"UPDATE saved_data_creating_channels SET first_user_name_list = ?, second_user_name_list = ?, "
