...
class Window_proxy(QtWidgets.QMainWindow):
    def __init__(self, switch_window=None):
        ...
        self.lineEdit_port_socks5.setPlaceholderText("54357")  # Подсказка
        ...
        self.lineEdit_login_socks5.setPlaceholderText("GXjdf8fsK3")  # Подсказка
        ...
        self.lineEdit_password_socks5.setPlaceholderText("qjghPld4C")  # Подсказка
        ...
        self.lineEdit_ip_socks5.setPlaceholderText("85.172.732.850")  # Подсказка
    ...
    def _open_info(self):
        ui = Dialog_info('Информация!', 'Для получения актуальных данных о аккаунте, необходимо войти в него\n'
    ...
    def _editing_finished(self):
        ...
        cursor.execute(f"UPDATE proxy SET ip = ?, port = ?, login = ?, password = ?",
                       (self.lineEdit_ip_socks5.text(),int(self.lineEdit_port_socks5.text()),
    ...
    def _check_proxy(self):
        ...
        if result:
            info = Dialog_info('Информация!', f'Успешное подключение к прокси! \nIP: {result}',
                            'notification.mp3')
        else:
            info = Dialog_info('Информация!', f'К прокси не удалось подключиться!',
                               'notification.mp3')
