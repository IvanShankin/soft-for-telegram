...
from app.general.ui.dialog_error_proxy_for_work_ui import DialogErrorProxyUi
...
class DialogErrorProxyForWork(DialogErrorProxyUi):
...
if __name__ == "__main__":
    ...
    ui = DialogErrorProxyForWork('83.217.5.96','11225','FvngSoSAQj','LNyr1N65pR')
    ui.show()
    sys.exit(app.exec_())
