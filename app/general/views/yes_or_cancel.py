...
from app.general.ui.dialog_yes_or_cancel_ui import DialogYesOrCancelUi
...
class DialogYesOrCancel(DialogYesOrCancelUi):
...
if __name__ == "__main__":
    ...
    ui = DialogYesOrCancel('Внимание!','test','notification.mp3')
    ui.show()
    sys.exit(app.exec_())
