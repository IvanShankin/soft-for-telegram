...
class DialogListCreatedBotUi(QDialog):
    def __init__(self):
        super().__init__()
...
"")
        ...
        self.label_title_2.setStyleSheet("padding-left: 15px;\n"
"border-top: none;\n"
"border-bottom: none;\n"
"")
...
"margin: 1px;")
        ...
        self.scrollAreaWidgetContents_8.setGeometry(QtCore.QRect(0, 0, 463, 458))
...
"}")
    ...
    def retranslateUi(self):
        ...
        self.label_title_2.setText(_translate("Dialog", "Список созданных user_names ботов"))
