...
class TextEditDescription(QTextEdit):
    ...
    def focusOutEvent(self, event):
        ...
        for counter in range(len(description_list)):
            if len(description_list[counter]) > 512:
                info = DialogInfo('Внимание!', "Описание не может превышать 512 символов!\n"
...
class TextEditChannelName(QTextEdit):
    ...
    def focusOutEvent(self, event):
        ...
        for counter in range(len(channel_name_list)):
            if len(channel_name_list[counter]) > 64:
                info = DialogInfo('Внимание!', "Имя канала не может превышать 64 символов!\n"
                                                f"Ваше {counter} имя канала не проходит по этому ограничению",
                                   "notification.mp3")
                info.exec_()
                return

class WindowCreateBotUi(QtWidgets.QMainWindow):
    def __init__(self):
        super().__init__()
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(self.root_project_dir + "/resources/panel/logo.PNG"),
        ...
        self.pushButton_account.setStyleSheet("QPushButton {\n"
                                              ...
                                              "            }")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(self.root_project_dir + "/resources/panel/account.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_mailing.setStyleSheet("QPushButton {\n"
                                              ...
                                              "            }")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(self.root_project_dir + "/resources/panel/mailing.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_invite.setStyleSheet("QPushButton {\n"
                                             ...
                                             "            }")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(self.root_project_dir + "/resources/panel/invaite.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_parser.setStyleSheet("QPushButton {\n"
                                             ...
                                             "            }")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(self.root_project_dir + "/resources/panel/parser.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_proxy.setStyleSheet("QPushButton {\n"
                                            ...
                                            "            }")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(self.root_project_dir + "/resources/panel/proxy.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_bomber.setStyleSheet("QPushButton {\n"
                                             ...
                                             "            }")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(self.root_project_dir + "/resources/panel/bomber.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_create_channel.setStyleSheet("QPushButton {\n"
                                                     ...
                                                     "            }")
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(self.root_project_dir + "/resources/panel/channel.png"), QtGui.QIcon.Normal,
                        QtGui.QIcon.Off)
        self.pushButton_create_channel.setIcon(icon17)
        ...
        self.pushButton_enter_group.setStyleSheet("QPushButton {\n"
                                                  ...
                                                  "            }")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(self.root_project_dir + "/resources/panel/enter_the_group.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_reactions.setStyleSheet("QPushButton {\n"
                                                ...
                                                "            }")
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(self.root_project_dir + "/resources/panel/like.png"),
                        QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_comment.setStyleSheet("QPushButton {\n"
                                              ...
                                              "            }")
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(self.root_project_dir + "/resources/panel/coment.png"),
                         QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_convert.setStyleSheet("QPushButton {\n"
                                              ...
                                              "            }")
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(self.root_project_dir + "/resources/panel/convert.png"),
                         QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.pushButton_doc.setStyleSheet("QPushButton {\n"
                                          ...
                                          "            }")
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(self.root_project_dir + "/resources/panel/doc.png"),
                         QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.scrollAreaWidgetContents_6.setGeometry(QtCore.QRect(0, 0, 310, 335))
        ...
        self.textEdit_name_list = TextEditChannelName(self.scrollAreaWidgetContents_6)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.textEdit_name_list.sizePolicy().hasHeightForWidth())
        self.textEdit_name_list.setSizePolicy(sizePolicy)
        self.textEdit_name_list.setMinimumSize(QtCore.QSize(0, 0))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.textEdit_name_list.setFont(font)
        self.textEdit_name_list.setStyleSheet("background-color: rgb(255, 255, 255);\n"
                                                  "border-radius: 20px;\n"
                                                  "padding-top: 15px; /* Отступ только слева */   \n"
                                                  " padding-bottom: 15px; /* Отступ только снизу */\n"
                                                  "")
        self.textEdit_name_list.setReadOnly(False)
        self.textEdit_name_list.setObjectName("textEdit_name_list")
        self.gridLayout_15.addWidget(self.textEdit_name_list, 0, 0, 1, 1)
        ...
        self.pushButton_info_list_name_bot = QtWidgets.QPushButton(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_info_list_name_bot.sizePolicy().hasHeightForWidth())
        self.pushButton_info_list_name_bot.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setStyleStrategy(QtGui.QFont.PreferDefault)
        self.pushButton_info_list_name_bot.setFont(font)
        self.pushButton_info_list_name_bot.setStyleSheet("border: none;\n"
                                                         "background: none;")
        self.pushButton_info_list_name_bot.setText("")
        icon14 = QtGui.QIcon()
        icon14.addPixmap(
            QtGui.QPixmap(self.root_project_dir + "/resources/icon/question.png"),
            QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_info_list_name_bot.setIcon(icon14)
        self.pushButton_info_list_name_bot.setIconSize(QtCore.QSize(30, 30))
        self.pushButton_info_list_name_bot.setFlat(False)
        self.pushButton_info_list_name_bot.setObjectName("pushButton_info_list_name_bot")
        self.gridLayout_6.addWidget(self.pushButton_info_list_name_bot, 0, 1, 1, 1)
        ...
        self.pushButton_info_list_description.setIcon(icon14)
        ...
        self.scrollAreaWidgetContents_7.setGeometry(QtCore.QRect(0, 0, 310, 335))
        ...
        self.gridLayout.addWidget(self.pushButton_choose_user_name, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBox_use_proxy, 6, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_random_choice_photo, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.checkBox_random_choice_photo, 1, 0, 1, 1)
        ...
        self.checkBox_set_BIO = QtWidgets.QCheckBox(self.groupBox_2)
        font = QtGui.QFont()
        font.setPointSize(14)
        self.checkBox_set_BIO.setFont(font)
        self.checkBox_set_BIO.setStyleSheet("\n"
                                            "QCheckBox {\n"
                                            "color: rgb(0, 0, 0);\n"
                                            "    spacing: 5px; /* Отступ между иконкой и текстом */\n"
                                            "\n"
                                            ...
                                            "    background-color: rgb(180, 230, 180); \n"
                                            "}")
        self.checkBox_set_BIO.setObjectName("checkBox_set_BIO")
        self.gridLayout.addWidget(self.checkBox_set_BIO, 2, 0, 1, 1)
        self.pushButton_set_BIO = QtWidgets.QPushButton(self.groupBox_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_set_BIO.sizePolicy().hasHeightForWidth())
        self.pushButton_set_BIO.setSizePolicy(sizePolicy)
        self.pushButton_set_BIO.setMinimumSize(QtCore.QSize(0, 31))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.pushButton_set_BIO.setFont(font)
        self.pushButton_set_BIO.setStyleSheet("QPushButton {\n"
                                              "  background: rgb(210, 210, 213);\n"
                                              "text-align: center;\n"
                                              "border-radius: 10px;\n"
                                              "   }\n"
                                              ...
                                              "            }\n"
                                              "")
        self.pushButton_set_BIO.setObjectName("pushButton_set_BIO")
        self.gridLayout.addWidget(self.pushButton_set_BIO, 2, 1, 1, 1)
        ...
        validator = QIntValidator(1, 99999)  # Минимум 1, максимум большое число
        ...
        self.lineEdit_max_create_from_one_account = QtWidgets.QLineEdit(self.groupBox_3)
        self.lineEdit_max_create_from_one_account.setMaximumSize(QtCore.QSize(60, 16777215))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lineEdit_max_create_from_one_account.setFont(font)
        validator = QIntValidator(1, 99999)  # Минимум 1, максимум большое число
        self.lineEdit_max_create_from_one_account.setValidator(validator)
        self.lineEdit_max_create_from_one_account.setStyleSheet("QLineEdit {\n"
                                                                        "    background-color: rgb(255, 255, 255);      /* Цвет фона текстового поля */\n"
                                                                        "    border: 2px solid rgb(150, 150, 150); /* Рамка текстового поля */\n"
                                                                        "    border-radius: 6px; /* Закругление углов */\n"
                                                                        "    padding: 2px; /* Отступы внутри текстового поля */\n"
                                                                        ...
                                                                        "    border: 2px solid rgb(200, 200, 200); /* Цвет рамки для отключенного */\n"
                                                                        "}")
        self.lineEdit_max_create_from_one_account.setMaxLength(5)
        self.lineEdit_max_create_from_one_account.setObjectName("lineEdit_max_create_from_one_account")
        self.gridLayout_10.addWidget(self.lineEdit_max_create_from_one_account, 0, 3, 1, 1)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 867, 358))
    ...
    def _update_data_in_db(self, data, column):
        ...
        cursor.execute(f"UPDATE saved_data_creating_bots SET {column} = ?",(data,))
        connection.commit()
        connection.close()
    ...
    def retranslateUi(self):
        ...
        self.label_18.setText(_translate("MainWindow", "Массовое создание ботов"))
        self.textEdit_name_list.setHtml(_translate("MainWindow",""))
        self.label_11.setText(_translate("MainWindow", "Список имён ботов:"))
        ...
        self.pushButton_random_choice_photo.setText(_translate("MainWindow", "Выбрать"))
        self.checkBox_random_choice_photo.setText(_translate("MainWindow", "Установить случайное фото"))
        self.label_17.setText(_translate("MainWindow", "user_names для ботов:"))
        self.checkBox_set_BIO.setText(_translate("MainWindow", "Установить БИО"))
        self.pushButton_set_BIO.setText(_translate("MainWindow", "Выбрать"))
        self.label_6.setText(_translate("MainWindow", "Количество запущенных потоков:"))
        self.label_7.setText(_translate("MainWindow", "Максимум созданных ботов с одного аккаунта:"))
