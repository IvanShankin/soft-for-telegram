...
class DialogListBIOBotUi(QDialog):
    def __init__(self):
        super().__init__()
...
"margin: 1px;")
        ...
        self.scrollAreaWidgetContents_8.setGeometry(QtCore.QRect(0, 0, 463, 488))
...
"}")
        ...
        self.textEdit_BIO_list = QtWidgets.QTextEdit(self.scrollAreaWidgetContents_8)
        self.textEdit_BIO_list.setMinimumSize(QtCore.QSize(0, 0))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.textEdit_BIO_list.setFont(font)
        self.textEdit_BIO_list.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"border-radius: 20px;\n"
"padding-top: 15px; /* Отступ только слева */   \n"
" padding-bottom: 15px; /* Отступ только снизу */\n"
"")
        self.textEdit_BIO_list.setReadOnly(False)
        self.textEdit_BIO_list.setObjectName("textEdit_BIO_list")
        self.gridLayout_20.addWidget(self.textEdit_BIO_list, 0, 0, 1, 1)
        ...
        self.pushButton_save = QtWidgets.QPushButton(self.scrollAreaWidgetContents_8)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_save.sizePolicy().hasHeightForWidth())
        self.pushButton_save.setSizePolicy(sizePolicy)
        self.pushButton_save.setMinimumSize(QtCore.QSize(111, 35))
        font = QtGui.QFont()
...
"}")
        ...
        self.pushButton_info = QtWidgets.QPushButton(self.scrollAreaWidgetContents_8)
    ...
    def retranslateUi(self):
        ...
        self.textEdit_BIO_list.setHtml(_translate("Dialog", ""))
        self.pushButton_save.setText(_translate("Dialog", "Сохранить"))
        self.label_3.setText(_translate("Dialog", "Список BIO для ботов"))
