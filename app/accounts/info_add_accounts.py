...
from app.accounts.info_add_folder_accounts import info_add_folder
...
class Dialog_info_add_accounts(QDialog):
    ...
    def open_info_folder(self):
        info = info_add_folder()  # Создаем экземпляр
